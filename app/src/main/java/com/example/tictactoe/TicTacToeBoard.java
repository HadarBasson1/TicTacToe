...
public class TicTacToeBoard extends View {
    ...
    public TicTacToeBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray arry = context.getTheme().obtainStyledAttributes(attrs, R.styleable.TicTacToeBoard, 0, 0);

        try {
            boardColor = arry.getInteger(R.styleable.TicTacToeBoard_boardColor, 0);
            XColor = arry.getInteger(R.styleable.TicTacToeBoard_XColor, 0);
            OColor = arry.getInteger(R.styleable.TicTacToeBoard_OColor, 0);
            winningLineColor = arry.getInteger(R.styleable.TicTacToeBoard_winningLineColor, 0);
        } finally {
            arry.recycle();
        }
    }
    ...
    private void drawVerticaline(Canvas canvas,int row,int col){
    ...
    private void drawWinningLine(Canvas canvas){
        ...
        switch (game.getWinType()[2]){
            case 1:
                ...
                break;
            case 2:
                drawVerticaline(canvas,row,col);
                break;
            case 3:
